	...
	return (
		<>
			...
			<main className="form-calculator">
				<Container>
					<div className="form-calculator-inner">
						<h1 className="form-calculator__title">
							{t("form_calculator.title")}
						</h1>
						<form
							className="form"
